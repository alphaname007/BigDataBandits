...
Ist dieser Tag noch nicht im Datensatz \textit{influences} enthalten, so wird für den aktuellen Tag zunächst das Intervall des Stock-Datensatzes bestimmt.
...
Schlussendlich werden alle Werte unter diesem Tag in den Datensatz \textit{influences} eingefügt.
